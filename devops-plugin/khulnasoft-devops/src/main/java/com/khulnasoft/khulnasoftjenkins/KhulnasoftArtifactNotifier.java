...
public class KhulnasoftArtifactNotifier extends Notifier implements SimpleBuildStep {
    /**
    ...
    private final boolean skipGlobalKhulnasoftArchive;
    private final String sizeLimit;

    @DataBoundConstructor
    public KhulnasoftArtifactNotifier(String includeFiles, String excludeFiles, boolean publishFromSlave,
                                  boolean skipGlobalKhulnasoftArchive, String sizeLimit) {
    ...
    public String toString() {
        return "KhulnasoftArtifactNotifier{" +
                "includeFiles='" + includeFiles + '\'' +
                ", excludeFiles='" + excludeFiles + '\'' +
                ", publishFromSlave=" + publishFromSlave +
                ", skipGlobalKhulnasoftArchive=" + skipGlobalKhulnasoftArchive +
                ", sizeLimit='" + sizeLimit + '\'' +
                '}';
    }
    ...
    public boolean isSkipGlobalKhulnasoftArchive() {
        return skipGlobalKhulnasoftArchive;
    }
