...
data class RefactorPreset(
    ...
    val languageWhitelist: List<KhulnasoftCommon.Language> = listOf(),
    val languageBlacklist: List<KhulnasoftCommon.Language> = listOf()
)
...
val REFACTOR_PRESETS: List<RefactorPreset> =
    listOf(
        ...
        RefactorPreset(
            ...
            languageWhitelist = listOf(KhulnasoftCommon.Language.LANGUAGE_PYTHON)),
        RefactorPreset(
        ...
        RefactorPreset(
            ...
            languageWhitelist = listOf(KhulnasoftCommon.Language.LANGUAGE_TSX)),
        RefactorPreset(
 ...
 */
fun getRefactorPresets(language: KhulnasoftCommon.Language): List<RefactorPreset> {
