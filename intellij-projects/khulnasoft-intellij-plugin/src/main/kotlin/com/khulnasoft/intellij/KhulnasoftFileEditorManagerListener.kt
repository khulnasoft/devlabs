...
class KHULNASOFTVisibleAreaListener : VisibleAreaListener {
...
class KHULNASOFTFileEditorManagerListener : FileEditorManagerListener {
  private var languageServer = service<LanguageServerService>()
  private var trackedEditor_: AtomicReference<Editor?> = AtomicReference(null)
  private var visibleAreaListener_ = KHULNASOFTVisibleAreaListener()
