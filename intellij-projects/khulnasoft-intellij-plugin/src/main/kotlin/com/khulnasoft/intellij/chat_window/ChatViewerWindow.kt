...
class ChatViewerWindow(
  ...
  private val khulnasoftStatusService: KhulnasoftStatusService = service<KhulnasoftStatusService>()
  ...
  fun loadClient() {
    var metadata: KhulnasoftCommon.Metadata = KhulnasoftCommon.Metadata.newBuilder().build()
    try {
    ...
    val searchParams =
        mapOf(
            ...
            "has_enterprise_extension" to khulnasoftStatusService.hasEnterprisePlugin().toString(),
        )
