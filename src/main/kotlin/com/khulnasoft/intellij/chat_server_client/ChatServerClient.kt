...
package com.khulnasoft.intellij.chat_server_client
...
import ksoft.chat_pb.Chat.ChatMessageIntent
import ksoft.chat_web_server_pb.ChatWebServer.WebServerRequest
  ...
  fun sendChatMessage(intent: ChatMessageIntent): Chat.ChatMessage {
    ...
    val message =
        Chat.ChatMessage.newBuilder()
            ...
            .setSource(KhulnasoftCommon.ChatMessageSource.CHAT_MESSAGE_SOURCE_USER)
