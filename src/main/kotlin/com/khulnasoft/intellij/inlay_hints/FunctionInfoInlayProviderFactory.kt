...
class FunctionInfoInlayProviderFactory : InlayHintsProviderFactory {
  ...
  internal class FunctionInfoInlayProvider : InlayHintsProvider<NoSettings> {
    ...
    override val name = "Khulnasoft chat inlay hints"
    override val previewText = "Hints to generate Khulnasoft Chat conversations."
    ...
    override fun createConfigurable(settings: NoSettings): ImmediateConfigurable {
      return object : ImmediateConfigurable {
        ...
        override val mainCheckboxText: String
          get() = "Show Khulnasoft Chat Inlay Hints"
      }
    }
  }
}
